...
def get_face_encodings(image):
    ...
    face_locations = faceRegLib.face_locations(image)
    face_encodings = faceRegLib.face_encodings(image, face_locations)
...
def compare_faces(encodings1, encodings2):
    ...
    matches = faceRegLib.compare_faces(encodings1, encodings2, tolerance=0.6)
    return any(matches)
